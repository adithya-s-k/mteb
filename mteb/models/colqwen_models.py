...
# Nayana-cognitivelab fine-tuned ColQwen2 models
nayana_colqwen2_v1_0_3000 = ModelMeta(
    loader=partial(
        ColQwen2Wrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-3000",
        revision="main",
        torch_dtype=torch.float16,
        attn_implementation="flash_attention_2"
        if is_flash_attn_2_available()
    ...
    name="Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-3000",
    languages=["eng-Latn"],
    revision="main",
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-3000",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)

nayana_colqwen2_v1_0_6langs_colbert_1430 = ModelMeta(
    loader=partial(
        ColQwen2Wrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-6langs-colbert-merged-1430",
        revision="main",
        torch_dtype=torch.float16,
        attn_implementation="flash_attention_2"
        if is_flash_attn_2_available()
    ...
    name="Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-6langs-colbert-merged-1430",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColQwen2-v1.0-6langs-colbert-merged-1430",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)
