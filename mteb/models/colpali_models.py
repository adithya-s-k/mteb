...
nayana_colpali_v1_3_22langs = ModelMeta(
    loader=partial(
        ColPaliWrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColPali-22langs-merged-6438",
        revision="main",
        torch_dtype=torch.bfloat16,
    ),
    name="Nayana-cognitivelab/NayanaEmbed-ColPali-22langs-merged-6438",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColPali-22langs-merged-6438",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)

# Trained with normalize_scores=True and Colbert loss
nayana_colpali_v1_3_6langs_1430 = ModelMeta(
    loader=partial(
        ColPaliWrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430",
        revision="main",
        torch_dtype=torch.float16,
    ),
    name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)

# Trained with normalize_scores=True and ColbertPairwiseCE loss
nayana_colpali_v1_3_6langs_1430_pairwise = ModelMeta(
    loader=partial(
        ColPaliWrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise",
        revision="main",
        torch_dtype=torch.float16,
    ),
    name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)

# Trained with normalize_scores=False and Colbert loss
nayana_colpali_v1_3_6langs_1430_norm_false = ModelMeta(
    loader=partial(
        ColPaliWrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-norm-False",
        revision="main",
        torch_dtype=torch.float16,
    ),
    name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-norm-False",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-norm-False",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)

# Trained with normalize_scores=False and ColbertPairwiseCE loss
nayana_colpali_v1_3_6langs_1430_pairwise_norm_false = ModelMeta(
    loader=partial(
        ColPaliWrapper,
        model_name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise-norm-False",
        revision="main",
        torch_dtype=torch.float16,
    ),
    name="Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise-norm-False",
    languages=["eng-Latn"],
    revision="main",
    release_date="2025-01-01",
    modalities=["image", "text"],
    ...
    public_training_data="https://huggingface.co/datasets/vidore/colpali_train_set",
    framework=["ColPali"],
    reference="https://huggingface.co/Nayana-cognitivelab/NayanaEmbed-ColPali-6langs-merged-1430-pairwise-norm-False",
    similarity_fn_name="max_sim",
    use_instructions=True,
    training_datasets=COLPALI_TRAINING_DATA,
)