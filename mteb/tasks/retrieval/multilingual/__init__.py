...
from .nayana_ir_retrieval import (
    NayanaIRCrossBench,
    NayanaIRMonoBench_ar,
    NayanaIRMonoBench_bn,
    NayanaIRMonoBench_de,
    NayanaIRMonoBench_en,
    NayanaIRMonoBench_es,
    NayanaIRMonoBench_fr,
    NayanaIRMonoBench_gu,
    NayanaIRMonoBench_hi,
    NayanaIRMonoBench_it,
    NayanaIRMonoBench_ja,
    NayanaIRMonoBench_kn,
    NayanaIRMonoBench_ko,
    NayanaIRMonoBench_ml,
    NayanaIRMonoBench_mr,
    NayanaIRMonoBench_or,
    NayanaIRMonoBench_pa,
    NayanaIRMonoBench_ru,
    NayanaIRMonoBench_sa,
    NayanaIRMonoBench_ta,
    NayanaIRMonoBench_te,
    NayanaIRMonoBench_th,
    NayanaIRMonoBench_zh,
)
